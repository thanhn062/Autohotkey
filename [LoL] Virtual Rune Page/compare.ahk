...
<!DOCTYPE html>
<html>
	<body style="background-color: #010E17 ;">
		...
		<!-- --> <img src="%A_ScriptDir%\TEST field\1920x1080 1600x900.bmp">
		<img style="width: %size%; height: 100`%" src="%A_ScriptDir%\images\rune\icon_runes_ability_power_red_tier3.png"> 
	</body>
</html>
)
...
ToolTip %x%
	...
	ImageSearch, findX, findY, 0, 0, A_ScreenWidth, A_ScreenHeight,*94 *w29 *h-1 %A_ScriptDir%\imi.bmp
	if !ErrorLevel
