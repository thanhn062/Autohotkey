...
Gui, Add, ActiveX, x0 y30 w302 h%act_H% vWB, Shell.Explorer
WB.silent := true
...
<html>
	...
	<body>
		<!-- SCROLL BAR -->
		<div id="scrollbar" style="filter: progid:DXImageTransform.Microsoft.Blur(PixelRadius=1,MakeShadow=true,ShadowOpacity=0.0);"></div>
		
		<!-- MENU -->
		<div id="arrow-up" style="display: none"></div>
			<div id="menu" style="display: none">
				<div id="menu-content" style="display: none">
				<span style="font-weight: 900;">List Category <button style="width: 35px; font-size: 20px; margin-left: 10px">+</button></span><hr>
					<ul>
						<li>Home</li>
						<li>School</li>
						<li>Programming</li>
		...
		<div id="list_container">
			...
			<div class="shadow1">
				<div class="list_item" name="1" oncontextmenu="javascript: alert(this.name);return false;">
					<div class="list_item_left">sssssssssssssss sssssssssssssss sssssssssssssss
			...
			<div class="shadow1">
				<div class="list_item" name="2" oncontextmenu="javascript:alert(this.name);return false;">
					<div class="list_item_left">sssssssssssssss sssssssssssssss sssssssssssssss
					<span>&#9955; <span style="position: relative; left: -18; top: -4; font-size: 12px;">&#8735;</span></span>
					<br><span class="list_item_info"><span style="font-size: 20px;">&#8635;</span> Due Today</span></div>
					<div class="list_item_right"><div class="list_item_div"></div>
...
return
F1::
WB.document.getElementById("scrollbar").style.filter := "progid:DXImageTransform.Microsoft.Blur(PixelRadius=1,MakeShadow=true,ShadowOpacity=0.5)"
return
Menu:
